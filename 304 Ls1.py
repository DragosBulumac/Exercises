...
patrate = [x ** 2 for x in range ( 1, 101 )]
print ( patrate )
# sau
...
# sau
l_100 = [ i for i in 'Astazi ploua cu soare'.split() ]
l_200 = [ i for i in 'Astazi ploua' ]
...
print ( la[1:11:2] ) # slicing cu pas
...
# Range
print ( "Numarele de la 0 la 5:" )
print ( list(range( 6 )) )
print ( "Numarele de la 7 la 10:" )
print ( list(range ( 7, 11 )) )
print ( "Numara cu pas de 3 pana la 51:" )
